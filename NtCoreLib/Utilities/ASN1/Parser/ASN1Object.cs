...
public abstract class ASN1Object : IDERObject
{
    ...
    internal static ASN1Object ToObject(DERValue value)
    {
        ...
        {
            DERTagType.Application => new ASN1Application(value),
            DERTagType.ContextSpecific => new ASN1ContextSpecific(value),
            DERTagType.Private => new ASN1Private(value),
            DERTagType.Universal => ASN1Universal.ToObject(value),
            _ => null,
        };
    }
    #endregion
