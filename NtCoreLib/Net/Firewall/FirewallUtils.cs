...
public static class FirewallUtils
{
    ...
    {
        return ale_layer switch
        {
            FirewallAleLayer.ConnectV4 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_CONNECT_V4,
            FirewallAleLayer.ConnectV6 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_CONNECT_V6,
            FirewallAleLayer.ListenV4 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_LISTEN_V4,
            FirewallAleLayer.ListenV6 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_LISTEN_V6,
            FirewallAleLayer.RecvAcceptV4 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4,
            FirewallAleLayer.RecvAcceptV6 => FirewallLayerGuids.FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6,
            _ => throw new ArgumentException("Unknown ALE layer", nameof(ale_layer)),
        };
    }
    ...
    {
        return ip_version switch
        {
            FirewallIpVersion.V4 => new IPAddress(BitConverter.ToUInt32(addr_bytes.Take(4).Reverse().ToArray(), 0)),
            FirewallIpVersion.V6 => new IPAddress(addr_bytes),
            _ => IPAddress.None,
        };
    }
