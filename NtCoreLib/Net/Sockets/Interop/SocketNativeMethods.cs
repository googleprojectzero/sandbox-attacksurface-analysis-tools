...
namespace NtCoreLib.Net.Sockets.Interop;
...
internal static class SocketNativeMethods
{
    ...
    [DllImport("hvsocket.dll", CharSet = CharSet.Unicode)]
    internal static extern bool GetHvSocketLocalAddress(out string addr);

    [DllImport("hvsocket.dll", CharSet = CharSet.Unicode)]
    internal static extern bool GetHvSocketParentAddress(out string addr);

    [DllImport("hvsocket.dll", CharSet = CharSet.Unicode)]
    internal static extern bool GetHvSocketSiloHostAddress(out string addr);
}
