...
internal static class NtWnfWellKnownNames
{
    ...
    private static Lazy<Dictionary<ulong, string>> _state_name_to_name = new(GetStateNameToName);
    private static Lazy<Dictionary<string, ulong>> _name_to_state_name = new(GetNameToStateName);
    ...
    private static Dictionary<ulong, string> GetStateNameToName()
    {
        ...
        {0x418B0223A3BC2075, "WNF_NLM_GLOBAL_CONNECTIVITY_STATE" },
    };
    }
    #endregion
