...
public static partial class NtSystemCalls
{
    ...
    [DllImport("ntdll.dll")]
    public static extern NtStatus NtSetInformationVirtualMemory(
        SafeKernelObjectHandle ProcessHandle,
        VirtualMemoryInformationClass VmInformationClass,
        IntPtr NumberOfEntries,
        MEMORY_RANGE_ENTRY[] VirtualAddresses,
        SafeBuffer VmInformation,
        int VmInformationLength
    );
...
public enum VirtualMemoryInformationClass
{
