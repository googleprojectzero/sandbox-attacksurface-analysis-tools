...
public class NtTransaction : NtObjectWithDuplicateAndInfo<NtTransaction, TransactionAccessRights, TransactionInformationClass, TransactionInformationClass>, INtTransaction
{
    ...
    public override NtResult<object> QueryObject(TransactionInformationClass info_class, bool throw_on_error)
    {
        ...
        {
            TransactionInformationClass.TransactionBasicInformation => (NtResult<object>)Query<TransactionBasicInformation>(info_class, default, throw_on_error),
            TransactionInformationClass.TransactionPropertiesInformation => (NtResult<object>)Query<TransactionPropertiesInformation>(info_class, default, throw_on_error),
            TransactionInformationClass.TransactionEnlistmentInformation => (NtResult<object>)Query<TransactionEnlistmentsInformation>(info_class, default, throw_on_error),
            TransactionInformationClass.TransactionSuperiorEnlistmentInformation => (NtResult<object>)Query<TransactionSuperiorEnlistmentInformation>(info_class, default, throw_on_error),
    ...
    {
        get => new(GetProperties().Timeout.QuadPart);
