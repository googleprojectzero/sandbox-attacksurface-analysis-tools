    ...
    TransactionManagerInformationClass, TransactionManagerInformationClass>
{
    ...
    public override NtResult<object> QueryObject(TransactionManagerInformationClass info_class, bool throw_on_error)
    {
        ...
        {
            TransactionManagerInformationClass.TransactionManagerBasicInformation => (NtResult<object>)Query<TransactionManagerBasicInformation>(info_class, default, throw_on_error),
            TransactionManagerInformationClass.TransactionManagerLogInformation => (NtResult<object>)Query<TransactionManagerLogInformation>(info_class, default, throw_on_error),
            TransactionManagerInformationClass.TransactionManagerRecoveryInformation => (NtResult<object>)Query<TransactionManagerRecoveryInformation>(info_class, default, throw_on_error),
