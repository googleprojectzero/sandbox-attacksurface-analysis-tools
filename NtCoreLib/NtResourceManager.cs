                                ...
                                ResourceManagerInformationClass, ResourceManagerInformationClass>
{
    ...
    public override NtResult<object> QueryObject(ResourceManagerInformationClass info_class, bool throw_on_error)
    {
        ...
        {
            ResourceManagerInformationClass.ResourceManagerBasicInformation => (NtResult<object>)Query<ResourceManagerBasicInformation>(info_class, default, throw_on_error),
