...
{
    #region Constructors
    internal NtNamedPipeFileBase(SafeKernelObjectHandle handle, IoStatusBlock io_status)
    ...
    private static NtIoControlCode GetAttributeToIoCtl(PipeAttributeType attribute_type)
    {
        ...
        {
            PipeAttributeType.Pipe => NtWellKnownIoControlCodes.FSCTL_PIPE_GET_PIPE_ATTRIBUTE,
            PipeAttributeType.Connection => NtWellKnownIoControlCodes.FSCTL_PIPE_GET_CONNECTION_ATTRIBUTE,
            PipeAttributeType.Handle => NtWellKnownIoControlCodes.FSCTL_PIPE_GET_HANDLE_ATTRIBUTE,
    ...
    private static NtIoControlCode SetAttributeToIoCtl(PipeAttributeType attribute_type)
    {
        return attribute_type switch
        {
            PipeAttributeType.Pipe => NtWellKnownIoControlCodes.FSCTL_PIPE_SET_PIPE_ATTRIBUTE,
            PipeAttributeType.Connection => NtWellKnownIoControlCodes.FSCTL_PIPE_SET_CONNECTION_ATTRIBUTE,
            PipeAttributeType.Handle => NtWellKnownIoControlCodes.FSCTL_PIPE_SET_HANDLE_ATTRIBUTE,
            _ => throw new ArgumentException("Invalid attribute type"),
        };
    }
    ...
    public override NtResult<object> QueryObject(FileInformationClass info_class, bool throw_on_error)
    {
        ...
        {
            FileInformationClass.FilePipeInformation => (NtResult<object>)Query<FilePipeInformation>(info_class, default, throw_on_error),
            FileInformationClass.FilePipeLocalInformation => (NtResult<object>)Query<FilePipeLocalInformation>(info_class, default, throw_on_error),
            FileInformationClass.FilePipeRemoteInformation => (NtResult<object>)Query<FilePipeRemoteInformation>(info_class, default, throw_on_error),
...
{
    internal NtNamedPipeFile(SafeKernelObjectHandle handle, IoStatusBlock io_status)
        : base(handle, io_status)
    {
    }
...
{
    internal NtNamedPipeFileClient(SafeKernelObjectHandle handle, IoStatusBlock io_status)
        : base(handle, io_status)
    {
    }
