...
public static partial class NtSystemCalls
{
    ...
    public static extern NtStatus NtCancelSynchronousIoFile(SafeKernelObjectHandle ThreadHandle,
        [In] SafeIoStatusBuffer IoRequestToCancel, [Out] IoStatusBlock IoStatusBlock);
    ...
    [DllImport("ntdll.dll")]
    public static extern NtStatus NtCopyFileChunk(
        SafeKernelObjectHandle SourceHandle,
        SafeKernelObjectHandle DestinationHandle,
        SafeKernelObjectHandle EventHandle,
        SafeIoStatusBuffer IoStatusBlock,
        int Length,
        [In] LargeInteger SourceOffset,
        [In] LargeInteger DestOffset,
        [In] OptionalGuid SourceKey,
        [In] OptionalGuid DestKey,
        CopyFileChunkFlags Flags
    );
}
...
[Flags]
public enum RtlDosApplyFileIsolationRedirectionFlags
{
    None = 0,
    UseDotLocal = 1
}
...
public static partial class NtRtl
{
    ...
    public static extern NtStatus RtlDosPathNameToRelativeNtPathName_U_WithStatus(
      string DosFileName,
      [Out] UnicodeStringHeap NtFileName,
    ...
    [DllImport("ntdll.dll", CharSet = CharSet.Unicode)]
    public static extern NtStatus RtlDosApplyFileIsolationRedirection_Ustr(
        RtlDosApplyFileIsolationRedirectionFlags Flags,
        [In] UnicodeString OriginalName,
        [In] UnicodeString Extension,
        [In, Out] UnicodeStringAllocated StaticString,
        [In, Out] UnicodeStringHeap DynamicString,
        out IntPtr NewName, // This is a pointer to either StaticString or DynamicString.
        [In, Out] OptionalInt32 NewFlags,
        [In, Out] OptionalLength FileNameSize,
        [In, Out] OptionalLength RequiredLength);
}
...
public class IoStatusBlock
{
    ...
    public NtStatus Status => (NtStatus)(uint)Pointer.ToUInt64();

    /// <summary>
    /// Return the status information field. (32 bit)
    /// </summary>
    internal int Information32 => Information.ToInt32();
}

[StructLayout(LayoutKind.Sequential), SDKName("IO_STATUS_BLOCK")]
public struct IoStatusBlockStruct
{
    public UIntPtr Pointer;
    public IntPtr Information;
}
...
public enum FileOpenOptions
{
    ...
    [SDKName("FILE_CONTAINS_EXTENDED_CREATE_INFORMATION")]
...
[Flags]
public enum CopyFileChunkFlags
{
    None = 0,
}

[Flags]
public enum ExtendedCreateFlags : long
{
    None = 0,
    [SDKName("EX_CREATE_FLAG_FILE_SOURCE_OPEN_FOR_COPY")]
    SourceOpenForCopy = 0x00000001,
    [SDKName("EX_CREATE_FLAG_FILE_DEST_OPEN_FOR_COPY")]
    DestOpenForCopy = 0x00000002
}

[StructLayout(LayoutKind.Sequential)]
public struct EXTENDED_CREATE_INFORMATION
{
    public ExtendedCreateFlags ExtendedCreateFlags;
