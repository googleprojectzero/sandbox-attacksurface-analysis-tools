...
public class ServiceTriggerInformation
{
    ...
    {
        ret = new T[count];
        using SafeHGlobalBuffer buffer = new(ptr, count * Marshal.SizeOf(typeof(T)), false);
    ...
    internal static Guid NETWORK_MANAGER_FIRST_IP_ADDRESS_ARRIVAL_GUID = new("4f27f2de-14e2-430b-a549-7cd48cbc8245");
    internal static Guid NETWORK_MANAGER_LAST_IP_ADDRESS_REMOVAL_GUID = new("cc4ba62a-162e-4648-847a-b6bdf993e335");
    internal static Guid DOMAIN_JOIN_GUID = new("1ce20aba-9851-4421-9430-1ddeb766e809");
    internal static Guid DOMAIN_LEAVE_GUID = new("ddaf516e-58c2-4866-9574-c3b615d42ea1");
    internal static Guid FIREWALL_PORT_OPEN_GUID = new("b7569e07-8421-4ee0-ad10-86915afdad09");
    internal static Guid FIREWALL_PORT_CLOSE_GUID = new("a144ed38-8e12-4de4-9d96-e64740b1a524");
    internal static Guid MACHINE_POLICY_PRESENT_GUID = new("659FCAE6-5BDB-4DA9-B1FF-CA2A178D46E0");
    internal static Guid USER_POLICY_PRESENT_GUID = new("54FB46C8-F089-464C-B1FD-59D1B62C3B50");
    internal static Guid RPC_INTERFACE_EVENT_GUID = new("bc90d167-9470-4139-a9ba-be0bbbf5b74d");
    internal static Guid NAMED_PIPE_EVENT_GUID = new("1f81d131-3fac-4537-9e0c-7e7b0c2f4b55");
    internal static Guid CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID = new("2d7a2816-0c5e-45fc-9ce7-570e5ecde9c9");
    ...
    internal ServiceTriggerInformation(SERVICE_TRIGGER trigger)
    {
        ...
        List<ServiceTriggerCustomData> data = new();
