...
internal class _Unmarshal_Helper : NdrUnmarshalBufferDelegator
{
...
internal struct RPC_IF_ID_EPT : INdrStructure
{
    ...
    {
        m.WriteGuid(Uuid);
        m.WriteUInt16(VersMajor);
        m.WriteUInt16(VersMinor);
    }
    ...
    public RPC_IF_ID_EPT(Guid uuid, ushort versmajor, ushort versminor)
    {
        Uuid = uuid;
        VersMajor = versmajor;
        VersMinor = versminor;
...
internal struct ept_entry_t : INdrStructure
{
    ...
    private void Marshal(_Marshal_Helper m)
    {
        ...
        m.WriteVaryingAnsiString(NdrMarshalUtils.CheckNull(annotation, "Member18"));
    }
    void INdrStructure.Unmarshal(INdrUnmarshalBuffer u)
    {
        Unmarshal(new _Unmarshal_Helper(u));
...
internal struct twr_p_t : INdrConformantStructure
{
    ...
    private void Marshal(_Marshal_Helper m)
    {
        ...
        m.Write_5(NdrMarshalUtils.CheckNull(tower_octet_string, "Member4"), tower_length);
    }
    void INdrStructure.Unmarshal(INdrUnmarshalBuffer u)
    {
        Unmarshal(new _Unmarshal_Helper(u));
...
internal struct RPC_SID_EPT : INdrConformantStructure
{
    ...
    private void Marshal(_Marshal_Helper m)
    {
        ...
        m.Write_6(NdrMarshalUtils.CheckNull(SubAuthority, "Member8"), SubAuthorityCount);
    }
    void INdrStructure.Unmarshal(INdrUnmarshalBuffer u)
    {
        Unmarshal(new _Unmarshal_Helper(u));
...
internal struct RPC_SID_IDENTIFIER_AUTHORITY_EPT : INdrStructure
{
    ...
    private void Marshal(_Marshal_Helper m)
    {
        m.Write_7(NdrMarshalUtils.CheckNull(Value, "Member0"));
    }
    void INdrStructure.Unmarshal(INdrUnmarshalBuffer u)
    {
        Unmarshal(new _Unmarshal_Helper(u));
    ...
    {
        RPC_SID_IDENTIFIER_AUTHORITY_EPT ret = new();
