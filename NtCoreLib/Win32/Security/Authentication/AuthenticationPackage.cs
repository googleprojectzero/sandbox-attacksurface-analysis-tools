...
public class AuthenticationPackage
{
    ...
    private static readonly Lazy<IReadOnlyList<AuthenticationPackage>> _native_packages = new(GetNativePackages);
    private static readonly Lazy<Dictionary<string, AuthenticationPackage>> _managed_packages = new(GetManagedPackages);
    private static readonly Lazy<Dictionary<uint, AuthenticationPackage>> _native_packages_by_id = new(GetNativePackageById);
    ...
    {
        List<AuthenticationPackage> packages = new();
