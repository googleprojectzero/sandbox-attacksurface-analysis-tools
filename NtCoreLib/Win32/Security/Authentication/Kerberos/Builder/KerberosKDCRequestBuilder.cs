...
using NtCoreLib.Win32.Security.Authentication.Kerberos.Cryptography;
using System;
...
public abstract class KerberosKDCRequestBuilder
{
        ...
        string userrealm, KerberosAuthenticationKey key)
    {
        ...
        BinaryWriter writer = new(stm, Encoding.UTF8);
        ...
        KerberosChecksum checksum = new(KerberosChecksumType.HMAC_MD5,
