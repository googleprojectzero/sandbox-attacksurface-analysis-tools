...
internal static class KerberosCredentialCacheFileUtils
{
    ...
    private static DateTime BaseUnixTime = new(1970, 1, 1,
    ...
    {
        List<KerberosAuthorizationData> ret = new();
        int count = reader.ReadInt32BE();
        while (count > 0)
        {
    ...
    public static TimeSpan ReadKDCOffset(this BinaryReader reader)
    {
        ...
        MemoryStream stm = new(reader.ReadAllBytes(header_length));
