...
internal sealed class KerberosEncryptionEngineAESSHA196 : KerberosEncryptionEngine
{
    ...
    {
        return encryption_type switch
        {
            KerberosEncryptionType.AES128_CTS_HMAC_SHA1_96 => "Kerberos AES128-CTS-HMAC-SHA1-96",
            KerberosEncryptionType.AES256_CTS_HMAC_SHA1_96 => "Kerberos AES256-CTS-HMAC-SHA1-96",
            _ => null,
        };
    }
    ...
    {
        Rfc2898DeriveBytes pbkdf = new(Encoding.UTF8.GetBytes(password), Encoding.UTF8.GetBytes(salt), iterations);
    ...
    public override byte[] Encrypt(byte[] key, byte[] plain_text, KerberosKeyUsage key_usage)
    {
        ...
        HMACSHA1 hmac = new(KerberosEncryptionUtils.DeriveAesKey(key, derive_mac_key));
    ...
    internal static KerberosEncryptionEngineAESSHA196 AES128 = new(KerberosEncryptionType.AES128_CTS_HMAC_SHA1_96, KerberosChecksumType.HMAC_SHA1_96_AES_128);
    internal static KerberosEncryptionEngineAESSHA196 AES256 = new(KerberosEncryptionType.AES256_CTS_HMAC_SHA1_96, KerberosChecksumType.HMAC_SHA1_96_AES_256);
    #endregion
}
