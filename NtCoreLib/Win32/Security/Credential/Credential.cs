...
public sealed class Credential
{
    ...
    private string GetCredentialAsString()
    {
        ...
        return Type switch
        {
            CredentialType.DomainPassword or CredentialType.DomainVisiblePassword or CredentialType.DomainCertificate => Encoding.Unicode.GetString(_credblob),
            _ => string.Empty,
        };
    }
    ...
    internal Credential(CREDENTIAL cred)
    {
        ...
        if (cred.AttributeCount > 0 && cred.Attributes != IntPtr.Zero)
        {
            ...
            attrs.AddRange(buffer.ReadArrayUnsafe<CREDENTIAL_ATTRIBUTE>(0,
