...
public sealed class AuthZContext : IDisposable
{
    ...
    private static AUTHZ_CONTEXT_INFORMATION_CLASS SidTypeToInfoClass(AuthZGroupSidType type)
    {
        return type switch
        {
            AuthZGroupSidType.Device => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoDeviceSids,
            AuthZGroupSidType.Restricted => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoRestrictedSids,
            AuthZGroupSidType.Capability => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoCapabilitySids,
            _ => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoGroupsSids,
        };
    }
    ...
    private static AUTHZ_CONTEXT_INFORMATION_CLASS AttrTypeToInfoClass(AuthZSecurityAttributeType type)
    {
        return type switch
        {
            AuthZSecurityAttributeType.Device => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoDeviceClaims,
            AuthZSecurityAttributeType.User => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoUserClaims,
            _ => AUTHZ_CONTEXT_INFORMATION_CLASS.AuthzContextInfoSecurityAttributes,
        };
    }
