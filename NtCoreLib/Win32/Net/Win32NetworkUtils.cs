...
namespace NtApiDotNet.Win32.Net
{
    ...
    public static class Win32NetworkUtils
    {
        ...
        public static NtResult<IEnumerable<UdpListenerInformation>> GetUdpListeners(AddressFamily address_family, bool throw_on_error)
        {
            ...
            {
                case AddressFamily.InterNetwork:
                    return GetUdpListeners<MIB_UDPTABLE_OWNER_MODULE>(AddressFamily.InterNetwork,
                        UDP_TABLE_CLASS.UDP_TABLE_OWNER_MODULE, throw_on_error).Cast<IEnumerable<UdpListenerInformation>>();
                case AddressFamily.InterNetworkV6:
                    return GetUdpListeners<MIB_UDP6TABLE_OWNER_MODULE>(AddressFamily.InterNetworkV6,
                        UDP_TABLE_CLASS.UDP_TABLE_OWNER_MODULE, throw_on_error).Cast<IEnumerable<UdpListenerInformation>>();
                default:
                    throw new ArgumentException("Only support IPv4 and IPv6 address families.");
            }
