...
public struct FileIoCompletionInformation
{
    ...
    public IoStatusBlockStruct IoStatusBlock;
}
...
public class FileIoCompletionResult
{
    ...
    public IoStatusBlock IoStatusBlock { get; }
    ...
    internal FileIoCompletionResult(IntPtr key_context, IntPtr apc_context, IoStatusBlock io_status)
    {
