...
public class NtEnlistment : NtObjectWithDuplicateAndInfo<NtEnlistment, EnlistmentAccessRights, EnlistmentInformationClass, EnlistmentInformationClass>
{
    ...
    {
        return create_options switch
        {
            EnlistmentCreateOptions.None => TransactionNotificationMask.Rollback | TransactionNotificationMask.Commit | TransactionNotificationMask.Prepare |
                                TransactionNotificationMask.SinglePhaseCommit,
            EnlistmentCreateOptions.Superior => TransactionNotificationMask.Rollback | TransactionNotificationMask.CommitComplete
                                | TransactionNotificationMask.PrepareComplete | TransactionNotificationMask.PrePrepareComplete,
            _ => throw new ArgumentException("Invalid create options", nameof(create_options)),
        };
    }
    ...
    public override NtResult<object> QueryObject(EnlistmentInformationClass info_class, bool throw_on_error)
    {
        ...
        {
            EnlistmentInformationClass.EnlistmentBasicInformation => (NtResult<object>)Query<EnlistmentBasicInformation>(info_class, default, throw_on_error),
            EnlistmentInformationClass.EnlistmentCrmInformation => (NtResult<object>)Query<EnlistmentCrmInformation>(info_class, default, throw_on_error),
