...
/// </summary>
public class ProcessModuleInformation
{
    /// <summary>
    /// The module section.
    /// </summary>
    ...
    private ProcessModuleInformation(RtlProcessModuleInformation info)
    {
    ...
    internal static IEnumerable<ProcessModuleInformation> GetModules(SafeStructureInOutBuffer<RtlProcessModules> buffer)
    {
        return buffer.Data.ReadArrayUnsafe<RtlProcessModuleInformation>(0, buffer.Result.NumberOfModules)
            .Select(i => new ProcessModuleInformation(i)).ToList().AsReadOnly();
    }
}
