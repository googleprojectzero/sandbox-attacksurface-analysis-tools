...
public partial class NamedObjectForm : Form
{
    ...
    private NtObject? _object_handle;
    ...
    private void btnOpen_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                _object_handle = _open_object(name, checkReadOnly.Checked);
                _object_name = name;
    ...
    public NtObject ObjectHandle => _object_handle ?? throw new InvalidOperationException();

    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
    public bool ReadOnly { get; private set; }

    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
    public string ObjectName => _object_name ?? throw new InvalidOperationException();
