...
FunctionsToExport = 'Get-NtTokenPrimary', 'Get-NtTokenThread', 'Get-NtTokenEffective', 'Get-AccessibleAlpcPort', 'Set-NtTokenPrivilege',
					...
					'New-NtProcess', 'New-NtProcessConfig', 'Get-NtFilePath', 'Show-NtToken', 'Show-NtSecurityDescriptor', 'Get-NtIoControlCode',
					'Import-NtObject', 'Export-NtObject', 'Get-ExecutionAlias', 'New-ExecutionAlias'
