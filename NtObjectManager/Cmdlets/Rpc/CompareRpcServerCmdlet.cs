...
{
    private static Dictionary<Tuple<Guid, RpcVersion>, RpcServer> CreateDictionary(IEnumerable<RpcServer> servers)
    {
        Dictionary<Tuple<Guid, RpcVersion>, RpcServer> ret = new();
