...
#pragma warning disable 1591
    ...
    public static class NtWellKnownIoControlCodes
    {
        ...
        public static readonly NtIoControlCode IOCTL_DISK_GET_DRIVE_GEOMETRY = new NtIoControlCode(FileDeviceType.DISK, 0x0000, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_GET_PARTITION_INFO = new NtIoControlCode(FileDeviceType.DISK, 0x0001, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_SET_PARTITION_INFO = new NtIoControlCode(FileDeviceType.DISK, 0x0002, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_GET_DRIVE_LAYOUT = new NtIoControlCode(FileDeviceType.DISK, 0x0003, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_SET_DRIVE_LAYOUT = new NtIoControlCode(FileDeviceType.DISK, 0x0004, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_VERIFY = new NtIoControlCode(FileDeviceType.DISK, 0x0005, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_FORMAT_TRACKS = new NtIoControlCode(FileDeviceType.DISK, 0x0006, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_REASSIGN_BLOCKS = new NtIoControlCode(FileDeviceType.DISK, 0x0007, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_PERFORMANCE = new NtIoControlCode(FileDeviceType.DISK, 0x0008, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_IS_WRITABLE = new NtIoControlCode(FileDeviceType.DISK, 0x0009, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_LOGGING = new NtIoControlCode(FileDeviceType.DISK, 0x000a, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_FORMAT_TRACKS_EX = new NtIoControlCode(FileDeviceType.DISK, 0x000b, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_HISTOGRAM_STRUCTURE = new NtIoControlCode(FileDeviceType.DISK, 0x000c, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_HISTOGRAM_DATA = new NtIoControlCode(FileDeviceType.DISK, 0x000d, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_HISTOGRAM_RESET = new NtIoControlCode(FileDeviceType.DISK, 0x000e, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_REQUEST_STRUCTURE = new NtIoControlCode(FileDeviceType.DISK, 0x000f, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_REQUEST_DATA = new NtIoControlCode(FileDeviceType.DISK, 0x0010, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_CONTROLLER_NUMBER = new NtIoControlCode(FileDeviceType.DISK, 0x0011, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode SMART_GET_VERSION = new NtIoControlCode(FileDeviceType.DISK, 0x0020, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode SMART_SEND_DRIVE_COMMAND = new NtIoControlCode(FileDeviceType.DISK, 0x0021, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode SMART_RCV_DRIVE_DATA = new NtIoControlCode(FileDeviceType.DISK, 0x0022, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_CHECK_VERIFY = new NtIoControlCode(FileDeviceType.DISK, 0x0200, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_MEDIA_REMOVAL = new NtIoControlCode(FileDeviceType.DISK, 0x0201, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_EJECT_MEDIA = new NtIoControlCode(FileDeviceType.DISK, 0x0202, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_LOAD_MEDIA = new NtIoControlCode(FileDeviceType.DISK, 0x0203, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_RESERVE = new NtIoControlCode(FileDeviceType.DISK, 0x0204, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_RELEASE = new NtIoControlCode(FileDeviceType.DISK, 0x0205, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_FIND_NEW_DEVICES = new NtIoControlCode(FileDeviceType.DISK, 0x0206, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_GET_MEDIA_TYPES = new NtIoControlCode(FileDeviceType.DISK, 0x0300, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_CHECK_VERIFY = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0200, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_CHECK_VERIFY2 = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0200, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_MEDIA_REMOVAL = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0201, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_EJECT_MEDIA = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0202, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_LOAD_MEDIA = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0203, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_LOAD_MEDIA2 = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0203, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_RESERVE = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0204, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_RELEASE = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0205, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_FIND_NEW_DEVICES = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0206, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_EJECTION_CONTROL = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0250, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_MCN_CONTROL = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0251, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_GET_MEDIA_TYPES = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0300, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_GET_MEDIA_TYPES_EX = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0301, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_RESET_BUS = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0400, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_RESET_DEVICE = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0401, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_STORAGE_GET_DEVICE_NUMBER = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0420, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_STORAGE_PREDICT_FAILURE = new NtIoControlCode(FileDeviceType.MASS_STORAGE, 0x0440, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_GET_PARTITION_INFO_EX = new NtIoControlCode(FileDeviceType.DISK, 0x12, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_SET_PARTITION_INFO_EX = new NtIoControlCode(FileDeviceType.DISK, 0x13, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_GET_DRIVE_LAYOUT_EX = new NtIoControlCode(FileDeviceType.DISK, 0x14, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_SET_DRIVE_LAYOUT_EX = new NtIoControlCode(FileDeviceType.DISK, 0x15, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_CREATE_DISK = new NtIoControlCode(FileDeviceType.DISK, 0x16, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_GET_LENGTH_INFO = new NtIoControlCode(FileDeviceType.DISK, 0x17, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_PERFORMANCE_OFF = new NtIoControlCode(FileDeviceType.DISK, 0x18, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_GET_DRIVE_GEOMETRY_EX = new NtIoControlCode(FileDeviceType.DISK, 0x28, FileControlMethod.Buffered, FileControlAccess.Any);
        public static readonly NtIoControlCode IOCTL_DISK_GROW_PARTITION = new NtIoControlCode(FileDeviceType.DISK, 0x34, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_GET_CACHE_INFORMATION = new NtIoControlCode(FileDeviceType.DISK, 0x35, FileControlMethod.Buffered, FileControlAccess.Read);
        public static readonly NtIoControlCode IOCTL_DISK_SET_CACHE_INFORMATION = new NtIoControlCode(FileDeviceType.DISK, 0x36, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_DELETE_DRIVE_LAYOUT = new NtIoControlCode(FileDeviceType.DISK, 0x40, FileControlMethod.Buffered, FileControlAccess.Read | FileControlAccess.Write);
        public static readonly NtIoControlCode IOCTL_DISK_UPDATE_PROPERTIES = new NtIoControlCode(FileDeviceType.DISK, 0x50, FileControlMethod.Buffered, FileControlAccess.Any);
        ...
        private static Lazy<Dictionary<string, NtIoControlCode>> _name_to_control_code = new Lazy<Dictionary<string, NtIoControlCode>>(BuildNameToControlCode);
