...
namespace NtApiDotNet.Utilities.SafeBuffers
{
    ...
    /// </summary>
    public class GuidArraySafeBuffer : SafeHGlobalBuffer
    {
        ...
        public GuidArraySafeBuffer(Guid[] guids) 
        ...
        /// </summary>
        public GuidArraySafeBuffer Null => new GuidArraySafeBuffer();
    }
}
